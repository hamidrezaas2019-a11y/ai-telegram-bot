...
// ============================================================
// PART 1: COMPLETE CONFIGURATION (Lines 1-800)
// ============================================================

const CONFIG = {
  // Bot Token & Admin
  BOT_TOKEN: BOT_TOKEN || '',
  ADMIN_IDS: (ADMIN_IDS || '').split(',').filter(id => id),
  VERSION: '4.0.0',
  
  // API Keys - All AI Providers
  ...
  CARD_PAYMENT_KEY: CARD_PAYMENT_KEY || '',
...
async function setWebhook(env) {
  ...
  const webhookUrl = CONFIG.WEBHOOK_URL || 'https://your-worker.workers.dev/webhook';
