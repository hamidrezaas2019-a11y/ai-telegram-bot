...
const CONFIG = {
  // ---- Bot Settings ----
  // BOT_TOKEN: '8123456789:AAHxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx',  // ← کامنت شد (چون تو Environment Variables هست)
  ADMIN_IDS: [5989309344, 7343696403],  // ← عوض شد
  VERSION: '5.0.0',
  ...
  // ---- URLs ----
WEBHOOK_URL: 'https://ai-telegram-bot.hamidreza-as2019.workers.dev/webhook',  // ← عوض کن
MINIAPP_URL: 'https://ai-telegram-bot.hamidreza-as2019.workers.dev/miniapp',  // ← عوض کن
    ...
    try {
      ...
      if (path === '/setwebhook') {
        ...
        try {
          ...
          if (!botToken) {
            return new Response(JSON.stringify({ success: false, error: 'BOT_TOKEN not configured' }), {
              status: 400,
              headers: { 'Content-Type': 'application/json' }
            });
          }
...
- Total Providers: ${TOTAL_PROVIDERS.size}
`);
