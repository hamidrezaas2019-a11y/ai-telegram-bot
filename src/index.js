...
const CONFIG = {
  ...
  SUBSCRIPTION_PLANS: {
    test: {
      ...
      price: 15000,
      days: 1,
      features: { text: 50, image: 20, video: 0, voice: 10, models: ['gemini-2.0-flash', 'gpt-4o-mini'] },
    ...
    image_pack: {
      ...
      price: 49000,
      days: 0,
      features: { text: 50, image: 100, video: 0, voice: 0, models: ['dall-e-3', 'midjourney-v7', 'flux-pro'] },
    ...
    video_pack: {
      ...
      price: 79000,
      days: 0,
      features: { text: 50, image: 0, video: 50, voice: 0, models: ['runway-gen4', 'kling-ultra', 'sora-2'] },
    ...
    gold: {
      ...
      price: 199000,
      days: 30,
      features: { text: 500, image: 200, video: 50, voice: 100, models: ['all'] },
    ...
    premium_month: {
      ...
      price: 149000,
      days: 30,
      features: { text: 1000, image: 500, video: 100, voice: 200, models: ['all-premium'] },
    ...
    premium_year: {
      ...
      price: 999000,
      days: 365,
      features: { text: 9999, image: 9999, video: 9999, voice: 9999, models: ['all-premium'] },
